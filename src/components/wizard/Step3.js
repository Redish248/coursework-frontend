    ...
    render() {
        return(
            <div className="step">
                ...
                <h4>Пароль:</h4>
                <Password keyfilter={/[^\s]/} value={this.state.password} onChange={this.handleChange('password')}/>
                <h4>Подтвердите пароль:</h4>
                <Password keyfilter={/[^\s]/}  feedback={false} value={this.state.pass} onChange={(e) => {this.setState({pass: e.target.value}); this.checkPassword(e.target.value);}} />
                <div id="error"/>
